      ...
      return {
        ...
        tabs: [{
     	...
     	<ul>
     		...
     		<li>
     			<div class="content">
     				<h3>Zebullon Developers Network</h3>
     		...
     		<li>
     			<div class="content">
     				<h3>Uniract Integtated Services</h3>
    	...
    	<ul>
    		<li>
    			<div class="content">
    				<h3>Developer Student Clubs, UNIPORT</h3>
    				<p>Lead</p>
    			</div>
    			<div class="time">
    		...
    		<li>
    			<div class="content">
    				<h3>Google Africa <br>Developer Scholarship</h3>
    				<p>Mentor</p>
    			</div>
    			<div class="time">
